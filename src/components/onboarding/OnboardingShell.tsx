...
const stepKeys = ["stepInterest", "stepGoal", "stepWelcome"];
        ...
        {stepKeys.map((label, i) => (
          <div key={label} className="flex flex-1 flex-col items-center">
            <div className="flex w-full items-center">
              ...
              {i < stepKeys.length - 1 && <div className={`h-px flex-1 transition-colors duration-300 ${i < currentStep ? "bg-blue-600" : "bg-gray-200"}`} />}
            </div>
